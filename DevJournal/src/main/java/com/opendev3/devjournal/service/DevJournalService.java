...
public class DevJournalService {
    ...
    @Transactional
    public DevJournalDto getPost(Long id) {
        Optional<DevJournalEntity> devjournalEntityWrapper = devjournalRepository.findById(id);
    ...
    public Long savePost(DevJournalDto devjournalDto) {
        return devjournalRepository.save(devjournalDto.toEntity()).getId();
    }

    @Transactional
    public void deletePost(Long id) {

        devjournalRepository.deleteById(id);
    }
}
